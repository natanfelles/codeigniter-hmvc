...
To call a module controller from within a controller you can use ` this->load->module()` or ` odules::load()` and PHP5 method chaining is available for any object loaded by MX.
